...
impl GlobalProtoNoiseRouter {
    pub fn generate(ast: &NoiseRouterRepr, random_config: &GlobalRandomConfig) -> Self {
        ...
        Self {
            barrier_noise: Self::recursive_build_stack(
                ast.barrier_noise(),
                random_config,
                &mut stack,
                &mut map,
            ...
            fluid_level_floodedness_noise: Self::recursive_build_stack(
            ...
            continents: Self::recursive_build_stack(
                ast.continents(),
                random_config,
                &mut stack,
                &mut map,
            ...
            fluid_level_spread_noise: Self::recursive_build_stack(
            ...
            lava_noise: Self::recursive_build_stack(
                ast.lava_noise(),
                random_config,
                &mut stack,
                &mut map,
            ...
            depth: Self::recursive_build_stack(
                ast.depth(),
                random_config,
                &mut stack,
                &mut map,
            ...
            erosion: Self::recursive_build_stack(
                ast.erosion(),
                random_config,
                &mut stack,
                &mut map,
            ...
            temperature: Self::recursive_build_stack(
                ast.temperature(),
                random_config,
                &mut stack,
                &mut map,
            ...
            final_density: Self::recursive_build_stack(
                ast.final_density(),
                random_config,
                &mut stack,
                &mut map,
            ...
            initial_density_without_jaggedness: Self::recursive_build_stack(
            ...
            ridges: Self::recursive_build_stack(
                ast.ridges(),
                random_config,
                &mut stack,
                &mut map,
            ...
            vegetation: Self::recursive_build_stack(
                ast.vegetation(),
                random_config,
                &mut stack,
                &mut map,
            ...
            vein_gap: Self::recursive_build_stack(
                ast.vein_gap(),
                random_config,
                &mut stack,
                &mut map,
            ...
            vein_ridged: Self::recursive_build_stack(
                ast.vein_ridged(),
                random_config,
                &mut stack,
                &mut map,
            ...
            vein_toggle: Self::recursive_build_stack(
                ast.vein_toggle(),
                random_config,
                &mut stack,
                &mut map,
    ...
    pub(crate) fn recursive_build_stack<'a>(
        ...
        map.get(&ast_hash).copied().unwrap_or_else(|| {
            match ast {
                DensityFunctionRepr::Spline { spline, data } => {
                    let spline = match Self::recursive_build_spline(
                        spline,
                        random_config,
                        stack,
                        map,
                    ...
                    stack.push(ProtoNoiseFunctionComponent::Dependent(
                ...
                DensityFunctionRepr::BlendDensity { input } => {
                    ...
                    return Self::recursive_build_stack(
                        input,
                        random_config,
                        stack,
                        map,
                ...
                DensityFunctionRepr::ShiftedNoise {
                    ...
                    let input_x_index = Self::recursive_build_stack(
                        shift_x,
                        random_config,
                        stack,
                        map,
                    ...
                    let input_y_index = Self::recursive_build_stack(
                        shift_y,
                        random_config,
                        stack,
                        map,
                    ...
                    let input_z_index = Self::recursive_build_stack(
                        shift_z,
                        random_config,
                        stack,
                        map,
                ...
                DensityFunctionRepr::RangeChoice {
                    ...
                    let input_index = Self::recursive_build_stack(
                        input,
                        random_config,
                        stack,
                        map,
                    ...
                    let in_range_index = Self::recursive_build_stack(
                        when_in_range,
                        random_config,
                        stack,
                        map,
                    ...
                    let out_range_index = Self::recursive_build_stack(
                        when_out_range,
                        random_config,
                        stack,
                        map,
                ...
                DensityFunctionRepr::Binary {
                    ...
                    let input1_index = Self::recursive_build_stack(
                        argument1,
                        random_config,
                        stack,
                        map,
                    ...
                    let input2_index = Self::recursive_build_stack(
                        argument2,
                        random_config,
                        stack,
                        map,
                ...
                DensityFunctionRepr::Wrapper { input, wrapper } => {
                    ...
                    stack.push(ProtoNoiseFunctionComponent::Wrapper(Wrapper::new(
                        input_index,
                        *wrapper,
                        min_value,
                        max_value,
                ...
                DensityFunctionRepr::Unary { input, data } => {
                    ...
                    stack.push(ProtoNoiseFunctionComponent::Dependent(
                        DependentProtoNoiseFunctionComponent::Unary(Unary::new(input_index, data)),
                    ));
                }
            ...
            let component_index = stack.len() - 1;
            ...
            SplineRepr::Standard {
                ...
                let points: Vec<_> = locations
                    ...
                    .map(|((location, v), derivative)| {
                        let value = Self::recursive_build_spline(
                            v,
                            random_config,
                            stack,
                            map,
